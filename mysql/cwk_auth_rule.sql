...
-- ----------------------------
--  Table structure for `cwk_auth_rule`
-- ----------------------------
DROP TABLE IF EXISTS `cwk_auth_rule`;
CREATE TABLE `cwk_auth_rule` (
