...
-- ----------------------------
--  Table structure for `cwk_menu`
-- ----------------------------
DROP TABLE IF EXISTS `cwk_menu`;
CREATE TABLE `cwk_menu` (
